...
def cait_XXS24_224(pretrained=False, **kwargs):
    """
    In main.py file, there are the following code:
    ...
    when setting --model to cait_XXS24_224, then the argument "kwargs"
    of cait_XXS24_224 will contain a key "img_size", the following cait_models
    function will report an error:
    TypeError: type object got multiple values for keyword argument 'img_size'
    so, you need to delete the item in kwargs,
    """
    kwargs.pop("img_size")
    model = cait_models(
